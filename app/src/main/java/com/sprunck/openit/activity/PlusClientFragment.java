...
public final class PlusClientFragment extends Fragment
    ...
    /**
     * Array of strings representing actions to request for {@link #getArguments()}.
     */
    ...
    /**
     * Listener interface for sign in events.  Activities hosting a {@link com.sprunck.openit.activity.PlusClientFragment}
     * must implement this.
     */
     ...
     * @param actions  An array of actions to request.
    ...
    public static PlusClientFragment getPlusClientFragment(
            FragmentActivity activity, String[] scopes, String[] actions) {
        ...
        if (fragment instanceof PlusClientFragment) {
            ...
            if (Arrays.equals(actions,
                    fragment.getArguments().getStringArray(ARG_ACTIONS))) {
        ...
        arguments.putStringArray(ARG_ACTIONS, actions);
